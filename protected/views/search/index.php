...
<div class="single-product-area">
	...
	<div class="container">
		<?php if (empty($data)) : ?>
			<h3>No search results with this option!</h3>
		<?php else : ?>
			<div class="row">
				<?php
				...
				?>
					<div class="col-md-3 col-sm-6">
						<div class="single-shop-product">
							...
							<h2><a href="/product/detail/<?= getOptionSlug('product_id', $value->id) ?>"><span id="product_name_for_modal_<?= $value->id ?>"><?= getSubStrString($value->name, 55) ?></span></a></h2>
