...
class CurrencyRateController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CurrencyRate');
	...
	{
		$model=CurrencyRate::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CurrencyRate $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='currency-rate-form')
		{
