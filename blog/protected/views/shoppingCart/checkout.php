                            ...
                            <div id="customer_details" class="col2-set">
                                ...
                                <div class="col-2">
                                    <div class="woocommerce-shipping-fields">
                                        ...
                                        <div id="shipping_address_div" class="shipping_address" style="display: block;">
                                            ...
                                            <p id="shipping_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                <label class="" for="shipping_phone">Phone <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="shipping_phone" name="shipping_phone" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                        </div>
